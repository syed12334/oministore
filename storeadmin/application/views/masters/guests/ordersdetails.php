      ...
      ?>
          <div class="page has-sidebar-left bg-light height-full">
             <div class="container-fluid my-3">
                    <div class="row">
                        <div class="col-md-6">
                          <div class="card-title">Guest Orders Details</div>
                                            ...
                                            <thead>
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td><?php if($order_details[0]->pmode ==1) {echo "Online";}else {echo "COD";}?></td>
                                                </tr>
                                                <?php
                                                ...
                                                <?php
                                                    ...
                                                    <td><?=  date("d-m-Y",strtotime($order_details[0]->delivered_date));?></td>
                                                      ...
                                                      ?>
                                                        ...
                                                        <?php
                                                          if(count($payment) >0 && $payment[0]->pay_id !="") {
                                                            ?>
                                                                 <tr>
                                                    <th style="border-bottom:2px solid #e1e8ee!important;font-size:14px!important">Payment ID </th>
                                                    <td><?=  $payment[0]->pay_id;?></td>
                                                </tr>
                                                            <?php
                                                          }
                                                        ?>
    ...
    <tbody>
      ...
      ?>
                                ...
                                $tdiscount ="";
                                    if(!empty($order_details[0]->discount)) {
                                        ...
                                        ?>  
                                          ...
                                          <tr>
                              <th>Discount</th>
                              <td><?= "<i class='fas fa-indian-rupee'></i> ".number_format($order_details[0]->discount,2);?></td>
                            </tr>
                                        <?php
                                    }else {
                                        $tdiscount .=0;
                       ...
                       <div class="col-lg-12 col-sm-12 col-md-12">
                          <center>
    <a href="<?= base_url().'guestorders';?>" class="btn btn-primary"><i class="fas fa-arrow-left" style="margin-right: 2px"></i> Back</a>
  </center>
                       </div>
                       <div class="clearfix"></div>
                    </div>
