        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <a class="btn btn-success" href="<?= base_url().'testimonialsadd';?>" style="float: right;margin-bottom: 20px;margin-right: 20px"><i class="fa fa-plus"></i> Add</a>
                        <br /><br /><br />
...
<script type="text/javascript">
    ...
    function initialiseData(){
        ...
        dataTable = $('#category_table').DataTable( {
            ...
            "searching": true, 
            "ajax":{  
                  url:"<?=base_url().'master/getTestimonials'?>",  
                  type:"POST",
                  data: function(d){
                      d.forPost    = 1;
