                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                       <div class="form-group">
                                          <label>Color Name<span style="color:red">*</span></label>
                                              <input type="text" name="cname" id="cname" class="form-control" placeholder="Eg:Black" required>
                                       </div>
                                  </div>
                                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                       <div class="form-group">
                                          <label>Color Code<span style="color:red">*</span></label>
                                              <input type="color" name="ccode" id="ccode" class="form-control" required>
                                       </div>
                                  </div>
...
$(document).ready(function(){
  ...
  $(document).ready(function() {
      ...
      $("#category").validate({
            ...
            messages: {
                cname: "Please enter color name",
                ccode: "Please enter color name",
