                                 ...
                                 <?php
                                  if(count($category) >0) {
                                    foreach ($category as $value) {
                                        ?>
                                        <option value="<?= $value->id;?>" <?php if($subcategory[0]->sub_id == $value->id) {echo "selected";}?>><?= $value->cname;?></option>
                                        <?php
                                    }
                                  }
                                 ?>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                       <div class="form-group">
                                          <label>Subcategory Name<span style="color:red">*</span></label>
                                              <input type="text" name="cname" id="cname" class="form-control" placeholder="Eg:Suits" required value="<?= $subcategory[0]->ssname;?>">
                                       </div>
                                  </div>
                                  <div class="col-xs-12 col-sm-4 col-lg-4 col-md-4">
                                      <div class="form-group">
                                        ...
                                        <?php
                                          if(!empty($subcategory[0]->subsub_img)) {
                                            ?>
                                            <img src="<?= app_url().$subcategory[0]->subsub_img; ?>" style="width:100px">
                                            <?php
                                          }
                                        ?>
                                      </div>
