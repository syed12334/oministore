...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 30px">
            ...
            <table style="width:100%; float: left; border-top:1px solid #000; border-left:1px solid #000; border-right:1px solid #000;margin-bottom: 30px" cellpadding="0" cellspacing="0">
                                <tbody><tr>
                                    <th valign="top" align="center" style="border-bottom:1px solid #000; height:20px; border-right:1px solid #000; padding:1px;">Sl No</th>
                                    <th valign="top" align="center" style="border-bottom:1px solid #000; height:20px; border-right:1px solid #000; padding:1px;">Order ID</th>
                                    
                                </tr>
                                <tr>
                                    <td valign="top" align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;   height:20px; padding:1px;">1</td>
                                    <td valign="top" align="center" style="border-right:1px solid #000; border-bottom:1px solid #000;   height:20px; padding:1px;"><?= $orders[0]->orderid;?></td>
        ...
        <div class="clearfix"></div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h1 style="text-align: center;width:100%;margin-top: 30px">Your order has been cancelled</h1>
