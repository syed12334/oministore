...
-->
                             ...
                             <!--    <div class="availability p-0">
                                ...
                                <br />
                                  <button class="btn btn-primary btn-cartbtnss" data-pid="<?= encode($products[0]->pid);?>" id="cartBack<?= encode($products[0]->pid);?>" data-psid="<?= encode($products[0]->psid);?>" style="width:50%">
                                            <span>Add to </span>
                                    ...
                                    $disc = $this->home_db->discount($mrp, $sell);
                                         ...
                                         <div class="swiper-slide product">
                                            <figure class="product-media">
                                                ...
                                                if (!empty($disc) && $disc != 0) {
                                                    ?>
                                                     <a href="javascript:void(0)" id="discounttag<?= $value->pid;?>" class="btn-product-icon" style="text-align:center!important;"
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                if(!empty($value->mrp)) {
                                                    ?>
                                                    <del class="old-price sellmrps" id="sellmrpsss<?= $value->pid;?>">MRP <i class="fas fa-rupee-sign" style="margin-right: 5px"></i> <?php echo  $value->mrp;?></del>
                                                    <?php
                                                }
                                            ?>

                                              <ins class="new-price sellprices<?= $value->pid;?>" id="sellpricesss<?= $value->pid;?>" style="margin-left:10px">Offer <i class="fas fa-rupee-sign" style="margin-right: 2px"></i> <?= number_format($value->price);?> </ins>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
