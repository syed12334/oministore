                            ...
                            <div class="widget widget-about">
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="social-icons social-icons-colored">
                                        <?php
                                            if(is_array($sociallinks) && !empty($sociallinks) && count($sociallinks)) {
...
<!--    <div class="newsletter-popup mfp-hide">
        <div class="newsletter-content">
            ...
            <h2 class="ls-25">Sign up to ICCHHA Lifestyles</h2>
            <p class="text-light ls-10">Subscribe to the ICCHHA Lifestyles newsletter to
